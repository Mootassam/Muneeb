...
function WithdrawToolbar(props) {
  const [
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="withdraw-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="withdraw-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="withdraw-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="withdraw-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
