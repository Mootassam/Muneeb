...
function DepositToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    depositSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    depositSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="deposit-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="deposit-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="deposit-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="deposit-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {/* {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=deposit">
          <span
